...
public class EmailSender {
    public static void sendEmail(String toEmail, String bookTitle, String dueDate) {
        final String fromEmail = "thuvienhocvienkythuatmatma@gmail.com"; // Thay bằng Gmail của bạn
        final String password = "owri abiv meoi gssg"; // Thay bằng App Password đã tạo
