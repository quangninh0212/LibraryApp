...
public class OverdueChecker {    
    public static void checkOverdueBooks() {
        ...
        // Kết nối đến MySQL
        String url = "jdbc:mysql://localhost:3306/my_libary?autoReconnect=true&useSSL=false"; // Thay bằng database của bạn
        String user = "root"; // Thay bằng user MySQL
        String password = "123456789"; // Thay bằng password MySQL
